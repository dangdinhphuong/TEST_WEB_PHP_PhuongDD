                        ...
                        <div class="widget personal-info">
                            ...
                            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="comunity-name" name="price" step="0.01">
                                    <code> {{ $errors->first('price') }} </code>
                                </div>
                                <!-- Checkbox -->
                                <div class="form-group">
                                    <label for="zip-code">Amount</label>
                                    <input type="number" class="form-control" id="zip-code" name="amount">
                                    <code> {{ $errors->first('amount') }} </code>
                                </div>

                                <div class="form-check">
                                    <label class="form-check-label" for="hide-profile">
                                        <input class="form-check-input mt-1" name="status" type="checkbox" id="hide-profile">
                                        Active
                                    </label>
